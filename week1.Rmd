...
The data that have been copied to the `/u5/bergmal/EK60raw` now amount to `r sum(raw_files$size)` bytes.
...
raw_files %>%
  ...
  ggplot() +
    geom_line(aes(yyyy, avg_daily_size, group = ship, colour = ship))
 ```
